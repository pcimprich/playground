...
const getCompetition = (id, dispatch) => {
	...
	fetch('/api/competitions/' + id).then(function (response) {
		return response.json();
	}).then(function (competition) {
		//console.log('parsed competition: ', competition)

		fetch('/api/competitions/' + id + '/table').then(function (response) {
			return response.json();
			...
			fetch('/api/games?competition=' + id).then(function (response) {
				return response.json();
			}).then(function (games) {
